...
A JSON Schema for editor and tooling support lives at [`/schemas/data-driven-block-pack.schema.json`](/BlockEngine/schemas/data-driven-block-pack.schema.json).
