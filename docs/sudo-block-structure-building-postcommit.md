...
- Added the Block Engine Wand item, resource-pack model generation, and `/blockengine wand` give command.
...
- Removed the placeholder catalog route; placeholder authoring now starts from `/blockengine wand` and creative pick-block.
