...
public final class DemoStateBlockAdapter implements BlockAdapter {
    ...
    public void define(@NotNull BlockDefinition.Builder builder) {
        builder
                ...
                .state("red", state -> state
                        ...
                        .miningSpeed(1.0f)
                        .dropsItem(true)
                        .textures(textures -> textures.all("turtle_test:block/demo_state_red"))
                ...
                .state("green", state -> state
                        ...
                        .miningSpeed(1.0f)
                        .dropsItem(true)
                        .textures(textures -> textures.all("turtle_test:block/demo_state_green"))
                        .sounds(sounds -> sounds.mining("minecraft:block.stone.hit"))
                )
                .state("purple", state -> state
                        ...
                        .miningSpeed(1.0f)
                        .dropsItem(true)
                        .textures(textures -> textures.all("turtle_test:block/demo_state_purple"))
                        .sounds(sounds -> sounds.mining("minecraft:block.stone.hit"))
                );
    }
    ...
    public boolean onInteract(@NotNull BlockContext context, @NotNull Player player) {
        ...
        player.sendMessage("Turtle demo: state changed to " + next + ".");
        return true;
    }
